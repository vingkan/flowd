...
* Keyboard shortcuts are essential for high speed flow: the mouse should practically never be used.
* Saving the flow after a round is not a high priority, but if there were a tool to analyze saved flows, it would be more desirable.
* Debate jargon is often shortened, sometimes to single letters (critique -> k) with remarkable similarity among debaters from across the country.
* Most users appreciate color-coded flows.
* Being able to share a flow with a teammate during a round is a high priority.

# Launch
Visit vingkan.github.io/flowd to view the demo.
